...
class GameEngine {
  // Window init
  void create_window(const size_t width = 800, const size_t height = 600,
                     const std::string &title = "SFML", const size_t depth = 32,
                     const size_t framerate = 60,
                     const bool fullscreen = false);
  void create_window(const sf::VideoMode &mode, const std::string &title,
